...
import { ActivityFormaValues } from "../../../app/models/activity";
...
const ActivityForm: React.FC<RouteComponentProps<DetailParams>> = ({ match, history }) => {
  ...
  const [activity, setActivity] = useState(new ActivityFormaValues());
  ...
  useEffect(() => {
    if (match.params.id) {
      ...
      loadActivity(match.params.id)
        .then(activity => setActivity(new ActivityFormaValues(activity)))
